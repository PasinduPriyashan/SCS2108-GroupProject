        ...
        <div class="container">
            <div class="row contact_row">
                ...
                <div class="col-sm-6 contact_info send_message">
                    ...
                    <form class="form-inline contact_box" method="post" action="<?php echo site_url('Contact/insert')?>">
                        <input type="text" class="form-control input_box" placeholder="First Name *" name="firstName">
                        <input type="text" class="form-control input_box" placeholder="Last Name *" name="lastName">
                        <input type="text" class="form-control input_box" placeholder="Your Email *" name="email">
