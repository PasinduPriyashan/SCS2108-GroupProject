...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo base_url()?>assets/css/bootstrap.min.css" rel="s<?php echo base_url()?>assets/tylesheet">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
               <form>
                    ...
                    <textarea name="pagebody" class="form-control" placeholder="Post Body"></textarea>
                    </div>
                    <div class="checkbox">
                      <label>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <textarea name="pagebody1" class="form-control" placeholder="Page Body"></textarea>
              </div>
              <div class="checkbox">
                <label>
                  <input type="checkbox"> Published
