...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="<?php echo site_url('home/logout')?>">Logout</a>
      </li>
    </ul>
   ...
   <div class="jumbotron">
    ...
    <p class="lead">
      <a class="btn btn-primary btn-lg" href="<?php echo site_url('home/logout')?>" role="button">Logout</a>
    </p>
  </div>
